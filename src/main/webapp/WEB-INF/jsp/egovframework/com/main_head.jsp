...
<script type="text/javascript">
	function fn_main_headPageMove(menuNo, url){
	    ...
	    document.selectOne.action = "<c:url value='/sym/mnu/mpm/MainMenuLeft.do'/>";
	    document.selectOne.target = "main_left";
	    document.selectOne.submit();
 	    document.selectOne.action = "<c:url value='/sym/mnu/mpm/MainMenuRight.do'/>";
...
<input name="chkURL" type="hidden" />
    ...
    <div id="gnb">
    <div id="top_logo"><a href="<c:url value='/sym/mnu/mpm/MainMenuHome.do' />" target=_top><img src="<c:url value='/images/egovframework/com/cmm/main/logo_01.gif' />" alt="egovframe" /></a></div>
     <div id="use_descri">
            <ul>
                <li>공통서비스 테스트 사이트</li>
    ...
    <div id="new_topnavi">
        <ul>
			<li><a href="<c:url value='/sym/mnu/mpm/MainMenuHome.do' />" target="_top">HOME</a></li>
