...
function fInsertMenuCreat() {
    ...
    document.menuCreatManageForm.action = "<c:url value='/sym/mnu/mcm/AdminMenuCreatInsert.do'/>";
    document.menuCreatManageForm.submit();
}
/* ********************************************************
 * 메뉴사이트맵 생성 화면 호출
...
<body>
<form name="menuCreatManageForm" action ="<c:url value='/sym/mnu/mcm/AdminMenuCreatSelect.do' />" method="post">
