...
function fDeleteMenuList() {
    ...
    document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/AdminMenuManageListDelete.do'/>";
...
function selectUpdtMenuManageDetail(menuNo) {
	document.menuManageForm.req_menuNo.value = menuNo;
   	document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/AdminMenuManageListDetailSelect.do'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 최초조회 함수
			...
			<c:forEach var="result" items="${list_menumanage}" varStatus="status">
			  <tr>
			    ...
			    <td style="cursor:hand;">
			       <span class="link"><a href="<c:url value='/sym/mnu/mpm/AdminMenuManageListDetailSelect.do?req_menuNo='/>${result.menuNo}" onclick="selectUpdtMenuManageDetail('<c:out value="${result.menuNo}"/>'); return false;"><c:out value="${result.menuNm}"/></a></span>
			    </td>
