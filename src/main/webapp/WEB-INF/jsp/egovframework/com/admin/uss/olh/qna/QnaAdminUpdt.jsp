<%
 /**
  * [추가] - 2021.04.12
  * 관리자페이지에서 수정을 누른 후 목록을 누르면 프론트 화면으로 가는걸 막기위한 페이지
  */
%>
...
<!-- 상단타이틀 -->
<form:form commandName="qnaVO" action="${pageContext.request.contextPath}/admin/uss/olh/qna/updateQna.do" method="post" onSubmit="fn_egov_updt_qna(document.forms[0]); return false;">  
<div class="wTableFrm">
