...
<form:form commandName="authorManage" action="${pageContext.request.contextPath}/sec/ram/AdminAuthorUpdate.do" method="post" onSubmit="fncAuthorUpdate(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
