...
function updateMenuManage(form) {
	...
	if(confirm("<spring:message code="common.save.msg"/>")){
		...
		if(!validateMenuManageVO(form)){
            ...
            form.action="<c:url value='/sym/mnu/mpm/AdminMenuDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteMenuManage(form) {
	if(confirm("<spring:message code="common.delete.msg"/>")){
        form.action="<c:url value='/sym/mnu/mpm/AdminMenuManageDelete.do' />";
		form.submit();
	}
}
/* ********************************************************
...
<form:form commandName="menuManageVO" name="menuManageVO"  action ="<c:url value='/sym/mnu/mpm/AdminMenuDetailSelectUpdt.do' />" method="post">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left" colspan="3">
		        ...
		        <a id="popupProgrmFileNm" href="<c:url value='/sym/prm/AdminProgramListSearch.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
