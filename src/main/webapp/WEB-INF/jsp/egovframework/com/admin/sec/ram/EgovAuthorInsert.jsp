...
function fncAuthorUpdate() {
	var varFrom = document.getElementById("authorManage");
	varFrom.action = "<c:url value='/sec/ram/AdminAuthorUpdate.do'/>";
...
<form:form commandName="authorManage" action="${pageContext.request.contextPath}/sec/ram/AdminAuthorInsert.do" method="post" onSubmit="fncAuthorInsert(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
