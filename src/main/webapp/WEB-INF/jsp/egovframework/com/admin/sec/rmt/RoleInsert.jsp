...
function fncRoleUpdate() {
    var varFrom = document.getElementById("roleManage");
    varFrom.action = "<c:url value='/sec/rmt/AdminRoleUpdate.do'/>";
...
<body>
<form:form commandName="roleManage" method="post" action="${pageContext.request.contextPath}/sec/rmt/AdminRoleInsert.do" onSubmit="fncRoleInsert(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
