...
<%
  ...
  * @ 2021.04.19   홍성은          템플릿 구분 삭제 & 기본값으로 커뮤니티템플릿(113line), 미리보기버튼 없애고 삭제버튼 추가
...
<script type="text/javascript">
	...
	// 삭제 스크립트 추가 - 2021.04.19
	function delete_tmplatInfo(tmplatId){
		if(confirm("<spring:message code="common.delete.msg" />")){	
			// Delete하기 위한 키값을 셋팅
			document.templateInf.tmplatId.value = tmplatId;	
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="" onclick="delete_tmplatInfo('${TemplateInfVO.tmplatId}');return false;" title="삭제">삭제</a></span>
	</div>
