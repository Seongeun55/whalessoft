...
function fnDeleteUser(checkedIds) {
	if(confirm("<spring:message code="common.delete.msg" />")){
	    ...
	    document.userManageVO.action = "<c:url value='/uss/umt/AdminUserDelete.do'/>";
	    document.userManageVO.submit();
	}
}
...
<body>
<!-- content start -->
<form:form commandName="userManageVO" action="${pageContext.request.contextPath}/uss/umt/AdminUserSelectUpdt.do" name="userManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;"> 
<div class="wTableFrm">
