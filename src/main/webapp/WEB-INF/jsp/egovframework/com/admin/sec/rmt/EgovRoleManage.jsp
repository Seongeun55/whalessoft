...
function fncSelectRole(roleCode) {
    ...
    document.listForm.action = "<c:url value='/sec/rmt/AdminRole.do'/>";
    document.listForm.submit();
}

function fncAddRoleInsert() {
    location.href = "<c:url value='/sec/rmt/AdminRoleInsertView.do'/>";
}

function fncRoleListDelete() {
	if(fncManageChecked()) {
        if(confirm("삭제하시겠습니까?")) { //삭제하시겠습니까?
            document.listForm.action = "<c:url value='/sec/rmt/AdminRoleListDelete.do'/>";
            document.listForm.submit();
        }
    }
}
...
function fncAddRoleView() {
    document.listForm.action = "<c:url value='/sec/rmt/AdminRoleUpdate.do'/>";
    document.listForm.submit();
}
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sec/rmt/AdminRoleInsertView.do'/>" onClick="javascript:fncAddRoleInsert();"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
