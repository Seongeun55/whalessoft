...
<form:form commandName="roleManage" method="post" action="${pageContext.request.contextPath}/sec/rmt/AdminRoleUpdate.do" onSubmit="fncRoleUpdate(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/admin/sec/rmt/AdminRoleList.do'/>"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
