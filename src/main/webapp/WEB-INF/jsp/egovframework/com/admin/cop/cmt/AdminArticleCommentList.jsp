...
<!-- 댓글 내용  -->
	...
	<form:form commandName="articleCommentVO" action="${pageContext.request.contextPath}/admin/cop/cmt/insertArticleComment.do" method="post" onSubmit="fn_egov_insert_commentList(); return false;" style="clear:both;">
	<div class="wTableFrm" >
