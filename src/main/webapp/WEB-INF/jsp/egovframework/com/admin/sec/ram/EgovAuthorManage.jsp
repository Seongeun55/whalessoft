...
function fncSelectAuthor(author) {
    ...
    document.listForm.action = "<c:url value='/sec/ram/AdminAuthor.do'/>";
    document.listForm.submit();
}

function fncAddAuthorInsert() {
    location.replace("<c:url value='/sec/ram/AdminAuthorInsertView.do'/>");
}
...
function fncAuthorDeleteList() {
    ...
    if(fncManageChecked()) {
    	if(confirm("<spring:message code="common.delete.msg" />")){	//삭제하시겠습니까?
            document.listForm.action = "<c:url value='/sec/ram/AdminAuthorListDelete.do'/>";
            document.listForm.submit();
        }
    }
}
...
function fncAddAuthorView() {
    document.listForm.action = "<c:url value='/sec/ram/AdminAuthorUpdate.do'/>";
    document.listForm.submit();
}
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li style="border: 0px solid #d2d2d2;">
				...
				<span class="btn_b"><a href="<c:url value='/sec/ram/AdminAuthorInsertView.do'/>" onClick="javascript:fncAddAuthorInsert();"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
