...
function fncSelectGroupList(pageNo){
 ...
 // document.listForm.action = "<c:url value='/sec/gmt/AdminGroupSearchList.do'/>";
...
<form:form name="listForm" action="${pageContext.request.contextPath}/sec/gmt/AdminGroupSearchList.do" method="post">
<div class="popup">
