...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        ...
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/uss/umt/AdminUserDelete.do'/>";
...
function fnAddUserView() {
    document.listForm.action = "<c:url value='/uss/umt/AdminUserInsertView.do'/>";
    document.listForm.submit();
}
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/umt/AdminUserInsertView.do'/>" onClick="fnAddUserView(); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
