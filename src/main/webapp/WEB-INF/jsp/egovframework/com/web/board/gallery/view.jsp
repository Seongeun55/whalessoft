...
<div class="container">
    ...
    <section id="bo_v_atc">
		...
		<div class="btn" style="float:right">
			<a href="/board/list.do?bbsId=${param.bbsId}&pageIndex=${param.pageIndex}&searchWrd=${param.searchWrd}&searchCnd=${param.searchCnd}" style="display:block; line-height:21px;" class="s_submit">
