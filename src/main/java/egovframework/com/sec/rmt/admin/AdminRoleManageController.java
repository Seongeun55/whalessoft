package egovframework.com.sec.rmt.admin;
...
import egovframework.com.sec.ram.service.AuthorManageService;
import egovframework.com.sec.rmt.service.RoleManageService;
...
public class AdminRoleManageController {
	...
	public String selectRoleListView() throws Exception {
		return "egovframework/com/admin/sec/rmt/RoleManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rmt/AdminRole.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sec/rmt/AdminRoleInsertView.do")
	public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
			@ModelAttribute("roleManage") RoleManage roleManage, ModelMap model) throws Exception {

		authorManageVO.setAuthorManageList(AuthorManageService.selectAuthorAllList(authorManageVO));
		model.addAttribute("authorManageList", authorManageVO.getAuthorManageList());
		model.addAttribute("cmmCodeDetailList", getCmmCodeDetailList(new ComDefaultCodeVO(), "COM029"));

		return "egovframework/com/admin/sec/rmt/RoleInsert";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rmt/AdminRoleInsert.do")
	public String insertRole(@ModelAttribute("roleManage") RoleManage roleManage,
			@ModelAttribute("roleManageVO") RoleManageVO roleManageVO, BindingResult bindingResult, ModelMap model)
			throws Exception {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rmt/AdminRoleUpdate.do")
	public String updateRole(@ModelAttribute("roleManage") RoleManage roleManage, BindingResult bindingResult, ModelMap model) throws Exception {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rmt/AdminRoleListDelete.do")
	public String deleteRoleList(@RequestParam("roleCodes") String roleCodes, @ModelAttribute("roleManage") RoleManage roleManage, Model model) throws Exception {
