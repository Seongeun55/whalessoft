package egovframework.com.sec.ram.admin;
...
public class AdminAuthorManageController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/ram/AdminAuthor.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/ram/AdminAuthorInsert.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/ram/AdminAuthorUpdate.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/ram/AdminAuthorListDelete.do")
