package egovframework.com.sec.rgm.admin;
...
public class AdminAuthorGroupController {
	...
	public String selectAuthorGroupListView() throws Exception {
		...
		return "egovframework/com/admin/sec/rgm/AuthorGroupManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rgm/AdminAuthorGroupInsert.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sec/rgm/AdminAuthorGroupDelete.do")
