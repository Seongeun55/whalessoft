...
public class EgovCcmCmmnCodeManageController {
	 ...
	 * @param searchVO
	 * @param model
	 * @return "egovframework/com/admin/sym/ccm/cca/EgovCcmCmmnCodeList"
	 * @throws Exception
	 */
	 ...
	 * @param cmmnCodeVO
	 * @param model
	 * @return "egovframework/com/admin/sym/ccm/cca/EgovCcmCmmnCodeDetail"
	 * @throws Exception
	 */
	...
	public String insertCmmnCodeView(@ModelAttribute("cmmnCodeVO")CmmnCodeVO cmmnCodeVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/admin/sym/ccm/cca/EgovCcmCmmnCodeRegist";
	}
     ...
     * @param cmmnCodeVO
     * @param model
     * @return "egovframework/com/admin/sym/ccm/cca/EgovCcmCmmnCodeUpdt"
     * @throws Exception
     */
