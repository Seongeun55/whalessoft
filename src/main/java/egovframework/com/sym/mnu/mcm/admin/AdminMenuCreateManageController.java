package egovframework.com.sym.mnu.mcm.admin;
...
public class AdminMenuCreateManageController {
	...
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/admin/sym/mnu/mcm/MenuCreatManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/AdminMenuCreatSelect.do")
	public String selectMenuCreatList(@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/admin/sym/mnu/mcm/MenuCreat";
	}
	 ...
	 *            String
	 * @return 출력페이지정보 등록처리시 "forward:/sym/mnu/mcm/AdminMenuCreatSelect.do"
	 * @exception Exception
	 */
	@RequestMapping("/sym/mnu/mcm/AdminMenuCreatInsert.do")
	public String insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert, @RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
		...
		model.addAttribute("resultMsg", resultMsg);
		return "forward:/sym/mnu/mcm/AdminMenuCreatSelect.do";
	}
	...
	public String selectMenuCreatSiteMapInsert(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, @RequestParam("valueHtml") String valueHtml, ModelMap model
		...
		String currentPath = AdminMenuCreateManageController.class.getProtectionDomain().getCodeSource() == null ? "" : EgovStringUtil.isNullToString(AdminMenuCreateManageController.class.getProtectionDomain().getCodeSource().getLocation().getPath());
