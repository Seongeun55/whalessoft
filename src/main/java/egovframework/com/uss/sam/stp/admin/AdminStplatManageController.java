package egovframework.com.uss.sam.stp.admin;
...
import egovframework.com.uss.sam.stp.service.StplatManageService;
 ...
 */
@Controller
public class AdminStplatManageController {
    ...
    public String updateStplatCnView(@RequestParam("useStplatId") String useStplatId , @ModelAttribute("searchVO") StplatManageDefaultVO searchVO, ModelMap model)
            throws Exception {
