package egovframework.com.uss.ion.pwm.admin;
...
@Controller
public class AdminPopupManageController {

	private static final Logger LOGGER = LoggerFactory.getLogger(AdminPopupManageController.class);
	...
	public String PopupManageUpdt(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO, BindingResult bindingResult, ModelMap model) throws Exception {
	...
	public String PopupManageRegist(@RequestParam Map<?, ?> commandMap, @ModelAttribute("popupManageVO") PopupManageVO popupManageVO, BindingResult bindingResult,
